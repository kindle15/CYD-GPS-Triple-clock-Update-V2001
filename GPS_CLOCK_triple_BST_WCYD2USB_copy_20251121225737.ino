...
TimeChangeRule PDT = {"PDT", Second, Sun, Mar, 2, -420};    // DST, UTC-7
TimeChangeRule PST = {"PST", First, Sun, Nov, 2, -480};     // Standard, UTC-8
TimeChangeRule MDT = {"MDT", Second, Sun, Mar, 2, -360};    // DST, UTC-6
TimeChangeRule MST = {"MST", First, Sun, Nov, 2, -420};     // Standard, UTC-7
TimeChangeRule CDT = {"CDT", Second, Sun, Mar, 2, -300};    // DST, UTC-5
TimeChangeRule CST = {"CST", First, Sun, Nov, 2, -360};     // Standard, UTC-6
TimeChangeRule EDT = {"EDT", Second, Sun, Mar, 2, -240};    // DST, UTC-4
