# CYD-Gps-Triple-clock v.2.0.0.1, March 2026 kindle15
...
Author: Bruce E. Hall, Ported by CoolmdXi, Updated and further converted kindle15.
...
/**************************************************************************
      ...
      Author:   Bruce E. Hall, w8bh.net
        Date:   12 May 2022
    Hardware:   ESP32-v1 (ESP32-2432S028R), 2.8" ILI9341 TFT display,
    ...
    Software:   Arduino IDE version  2.3.2
                ESP32 Board          3.0.4   This is the board the board
						...
						version (board mgr search:
						esp32, install official)

                TFT_eSPI library     2.5.43  Make sure to copy ** User_Setup.h 
						from (Bodmer)witnessmenow @ 
						Github to the Arduino library* 
						after eSPI is installed. Screen 
						pins otherwise won't match up!

                TinyGPSPlus library  1.1.0  can use v1.0.3, or beta version 1.1 
						(which becomes v 1.1.0 in other 
						source locations), it's the same, 
						just different in nomenclature 
						via docs. (Mikal Hart)

                Timezone library     1.2.6  installs with official (Jack 
						Christensen)

		Time library	     1.6.1  installs when Timezone library is 
						installed (Michael Margolis
					https://playground.arduino.cc/Code/Time/) 

		XPT2046 Touch library 1.4   Paul Stroffregen
					    Arduino libraries need to be updated 
						using library/add zip using the 
						included library. See #include 
						lines for direct sources.
...
//Make sure to copy User_Setup.h from witnessmenow @ Github to the Arduino library after eSPI is installed. Screen pins otherwise won't match up!
#include <TimeLib.h>    // https://github.com/PaulStoffregen/Time
#include <TinyGPS++.h>  // https://github.com/mikalhart/TinyGPSPlus
#include <Timezone.h>   // https://github.com/JChristensen/Timezone
#include <XPT2046_Touchscreen.h> //https://github.com/witnessmenow/ESP32-Cheap-Yellow-Display/DisplayConfig/CYD2USB
//Launcher   https://github.com/bmorcelli/Launcher/tree/main/lib/CYD-touch
#include <Wire.h>                 
#include <SPI.h>                  

//// OUTDATED //// The sketch is set for British Summer Time (BST) and Greenwich Mean Time (GMT). You can modify this to match your local time zone rules by altering the TimeChangeRule.
